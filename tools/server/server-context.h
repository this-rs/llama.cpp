...
private:
    ...
    // [obrain LONG-RESUME] phantom-prefix compaction / info
    std::unique_ptr<server_res_generator> handle_slots_compact(const server_http_req & req, int id_slot, bool do_compact);
